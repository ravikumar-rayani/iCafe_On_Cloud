...
public class DigitalMenuRecycleViewFragment extends Fragment implements Toolbar.OnMenuItemClickListener, CartItemsUpdated {
    ...
    private void toggleViewMode() {
        if(ICafe.getCurrentViewMode() == Constants.GRID_VIEW_MODE) {
            ICafe.setCurrentViewMode(Constants.LIST_VIEW_MODE);
        } else if(ICafe.getCurrentViewMode() == Constants.LIST_VIEW_MODE) {
            ICafe.setCurrentViewMode(Constants.GRID_VIEW_MODE);
        }
    }

    private void toggleViewMenuItemIcon(){
        if(ICafe.getCurrentViewMode() == Constants.GRID_VIEW_MODE) {
